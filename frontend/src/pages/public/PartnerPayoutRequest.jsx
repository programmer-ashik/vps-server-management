...
const payoutSchema = z.object({
  ...
  bankAccountNumber: z
    .string()
    .trim()
    .min(3, "Bank account number is required"),
          ...
          <section className='relative overflow-hidden rounded-[30px] border border-sky-100 bg-[linear-gradient(140deg,#ffffff_0%,#f0f9ff_55%,#fff7ed_100%)] p-7 shadow-[0_34px_90px_-40px_rgba(59,130,246,0.32)] md:p-10'>
            ...
            <div className='relative'>
              ...
              <p className='mt-5 max-w-xl text-base leading-7 text-neutral-600 md:text-lg'>
                Share your payout amount, account number, and screenshot once.
                Admin will review the request, approve it, and settle it from
                the portal.
              </p>
              ...
              <div className='mt-8 rounded-2xl border border-sky-100 bg-white/75 p-5'>
                ...
                <p className='mt-2 text-sm leading-6 text-neutral-600'>
                  Use the bank account number where you expect payout and enter
                  the amount in USD. The screenshot can be attached now or added
                  later.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p className='mt-2 text-sm leading-6 text-neutral-500'>
                  Add the payout details carefully. The submitted date is
              ...
              <p className='text-center text-xs text-neutral-500'>
                Approved requests move to unpaid until admin completes the
                payout.
              </p>
            </form>
          </section>
